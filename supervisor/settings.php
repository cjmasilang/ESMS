...
<?php
  ...
  include "../classes/monitoring_checklist_items.php";
...
<div class="card ">
  <div class="card-header">
        ...
        <div class="card-body">
          <button type="button" class="btn btn-sm btn-primary mb-4" data-toggle="modal" data-target="#exampleModal" style='float:right'><i class='fa fa-plus'></i>Add Item</button>
              <table id="table">
                <thead>
                  <tr>
                    <td>Item Name</td>
