...
function BasicTable($header, $data)
{
    ...
    $this->Cell(100,7,'Name of Employer: '.$data['user1']->fname.' '.$data['user1']->lname,0,0,'L');
    $this->Ln();
    $this->Cell(100,7,'Name of Evaluator: '.$data['user2']->fname.' '.$data['user2']->lname,0,0,'L');
    $this->Ln();
    $this->Ln();
    ...
    foreach($groupies as $g){
                        $this->Cell(190,7,$g->category,1,0,'L');
        $this->Ln();
