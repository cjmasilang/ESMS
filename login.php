...
$ret= mysqli_query($con,"SELECT id,fname,cafe_id,user_level FROM users WHERE email='$useremail' and password='$dec_password'");
...
$_SESSION['cafe_id']=$num['cafe_id'];
$_SESSION['user_level']=$num['user_level'];
    header("location:supervisor/settings.php");
}
else
{
...
<html lang="en">
    ...
    <button class="btn btn-dark link" name="login" type="submit">Login</button>
    </div>
    </form>
    </div>
